            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown" >
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-book"></i>Wisata</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('tempatWisata.index') }}">Tempat Wisata</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('rumahMakan.index') }}">Rumah Makan</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('pemandu.index') }}">Pemandu</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('toko.index') }}">Toko Oleh-oleh</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('admin.pemesanan') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Pemesanan</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
