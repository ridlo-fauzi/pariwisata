                ...
                <div class="col-md-6 offset-3">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tambah Wisata</strong>
                        </div>
                        <div class="card-body">
                            <!-- Tambahkan formulir di sini -->
                            <form method="post" action="{{ route('tempatWisata.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="nama_wisata">Nama wisata</label>
                                    <input type="text" id="nama_wisata" name="nama_wisata" class="form-control">
                                    @error('nama_wisata')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="harga_wisata" name="harga_wisata" class="form-control">
                                    @error('harga_wisata')
